    ...
    <div class="container mt-3">
      <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <p class="card-title float-left"><b>Data Iklan</b></p>
              <p class="card-description float-right">
                <b-button variant="success" v-b-modal.modalIklan v-on:click="Add"><i class="mdi mdi-plus btn-icon-prepend"></i> Tambah</b-button>
              </p>
      ...
      <template v-slot:modal-title>
        ...
        <form ref="form">
          <div class="form-group">
            ...
            <input type="text" name="nama_barang" class="form-control" id="nama_barang" placeholder="Nama Barang" v-model="nama_barang">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="gambar" class="form-control" id="gambar" placeholder="Gambar" v-model="gambar">
          </div>
          <div class="form-group">
...
module.exports = {
  data : function(){
    return {
      ...
      key: "",
      iklan: [],
      fields: ["id", "nama_barang", "harga", "gambar", "lokasi", "deskripsi", "Aksi"],
    }
  },
